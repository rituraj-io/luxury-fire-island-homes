...
// BuyHero — full-bleed hero for the /buy landing. Same visual treatment as
// SellHero: rotated yellow script headline with a hard blue drop shadow,
// uppercase subcopy, parallax background, and the homepage intro cascade.
// Copy and image come from the buy CMS heroSection.
...
export default function BuyHero({ hero }: Props) {
